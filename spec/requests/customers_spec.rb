...
describe "get new_customer_path" do
  ...
  describe "put customer_path with valid data" do
    it "updates an entry and redirects to the show path for the customer" do
      #@customer = FactoryBot.create :customer, first_name: "Karen", last_name: "Bobby", phone: "1234567890", email: "karen@mail.com"
      customer = FactoryBot.create(:customer)
      #pp customer
      #byebug
      put customer_path(customer.id), params: {customer: {last_name: "Johnson"}}
      #byebug
      customer.reload
      expect(customer.last_name).to eq("Johnson")
